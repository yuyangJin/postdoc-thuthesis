...
model_names = ['h2o', 'roco', 'keyformer', 'snapkv', 'corm', 'llama2', 'gemma2']
sys_names = ['torch', 'dynamo', 'tensorrt', 'tvm','einnet', 'our']
...
plot([data_a100, data_h100], ['A100', 'H100'], model_names, sys_names, figure_name='e2e_6', add_legend=True)