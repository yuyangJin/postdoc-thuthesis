...
devices = ['A100', 'H100']
sys_names = ['flashattn', 'flashinfer', 'tensorrt', 'our']

attn = parse_csv(LOG_DIR + "attn.csv", sep='\t')
gemma2 = parse_csv(LOG_DIR + "gemma2.csv", sep='\t')
...
plot([attn, gemma2], devices, sys_names, figure_name='attn_time', add_legend=True)